...
| `authType`               | `'openai' \| 'localhost-nexus-redirect'`       | `'openai'`       | Authentication type for the AI service. Use `'localhost-nexus-redirect'` to connect to a local inference server at http://localhost:11434/v1 (ollama-compatible, no API key required).                                                                                                                                                                                                                                                                                                |
